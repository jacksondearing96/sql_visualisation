<template>
  <div class="home">
    <div class="container">
      ...
      <!-- Heading -->
      <div>
        <h2 class="text-center" style="margin-top: 10px;">Data Lineage Visualisation</h2>
        <p class="lead text-uppercase text-center" style="font-size: 16px;">BY | SIVT1</p>
      </div>
      <!-- End Heading -->
      ...
      <!-- Data Info -->
      <div class="text-center">
        <h1>Table's info down here maybe...</h1>
      </div>
    </div>
    <!--End Data Info -->
